...
class _HomePageState extends State<HomePage> {
  ...
  List<ContactsModel> _contactsMdl = [];
  ...
  Future<void> refreshContactList() async {
    ...
    setState(() {
      if (_contactsMdl.isNotEmpty) _contactsMdl.clear();
      if (users != null) {
        _contactsMdl.addAll(users.toList().reversed);
      }
    });
    ();
  }
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8.0),
              Expanded(
                child: _contactsMdl.isEmpty ? Text(_result) : _buildContact(),
              ),
  ...
  Widget _buildContact() {
    return ListView.separated(
      itemBuilder: (context, index) {
        final ctList = _contactsMdl[index];
        return Card(
          child: ListTile(
